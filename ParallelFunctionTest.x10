...
public class ParallelFunctionTest {
	...
	public static def main(args:Rail[String]) {
		...
		finish for(var x:Int = 0; x < 16; x++){
			...
			async{
				...
				map.add("Cat"+final_x, "Meow");
				Console.OUT.println("Added (Cat" + final_x + ", Meow) to Map");
				Console.OUT.println("Map contains key 'Cat"+final_x+"': " + map.contains("Cat"+final_x));
				Console.OUT.println();
